...
int main()
{
	...
	double end_income;
	double end_min_sum;
	one.first.Init(100, 20);//задаёт значения для 1го вагона
	one.second.Init(10, 50);//задаёт значения для 2го вагона
	one.third.Init(40, 10);//задаёт значения для 3го вагона
